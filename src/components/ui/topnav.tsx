...
export default function Topnav() {
  ...
  return (
    <nav className="h-16 w-full bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-4">
      ...
      >
        <div className="relative max-w-md mx-auto">
          ...
          <Input
            type="text"
            placeholder="Search..."
            className="pl-10 w-full bg-zinc-800 text-zinc-100 border-zinc-700 focus:border-zinc-500 placeholder-zinc-500"
          />
        </div>
      </div>
